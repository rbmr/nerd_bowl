...
| $f_X(x)$      | $\frac{1}{\sigma\sqrt{2\pi}}e^{-\frac{1}{2}(\frac{x-\mu}{\sigma})^2}$<br>for $x \in \mathbb{R}$ | $\frac{1}{2^{\nu/2}\Gamma(\nu/2)}x^{\nu/2-1}e^{-x/2}$<br>for $x > 0$ | $\frac{\Gamma(\frac{\nu+1}{2})}{\sqrt{\nu\pi}\Gamma(\frac{\nu}{2})}(1+\frac{x^{2}}{\nu})^{-\frac{\nu+1}{2}}$ |
| $F_X(x)$      | $\Phi(\frac{x-\mu}{\sigma})$                                                                    | (Incomplete Gamma)                                                   | (Table)                                                                                                      |
| $M_X(t)$      | $e^{\mu t + \frac{1}{2}\sigma^2 t^2}$                                                           | $(1-2t)^{-1/2}$<br>for $t < 1/2$                                     | Does not exist                                                                                               |
| $E(X)$        | $\mu$                                                                                           | $\nu$                                                                | $0$ (if $\nu > 1$)                                                                                           |
| $Var(X)$      | $\sigma^2$                                                                                      | $2\nu$                                                               | $\frac{\nu}{\nu-2}$ (if $\nu > 2$)                                                                           |
